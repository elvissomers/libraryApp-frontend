    ...
    <section class="bg-gray-100 my-20">
        <div class="container min-h-screen px-6 py-12 mx-auto lg:flex lg:items-center lg:gap-12">
            <div class="wf-ull lg:w-1/2">
                ...
                <h1 class="mt-3 text-2xl font-semibold text-gray-800  md:text-3xl">Pagina niet gevonden</h1>
                <!-- removed: dark:text-gray-400 -->
                <p class="mt-4 text-gray-500 ">Sorry, de pagina waar je op zoek naar bent, bestaat niet. Hier zijn wat hulpzame links:</p>

                <div class="flex items-center mt-6 gap-x-3">
                    <!-- removed: dark:hover:bg-gray-800 dark:bg-gray-900 hover:bg-gray-100 dark:text-gray-200 dark:border-gray-700 -->
                    ...
                    <!-- removed: dark:hover:bg-blue-500 dark:bg-blue-600 -->
