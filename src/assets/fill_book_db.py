...
def get_json(bol_url):
        ...
        try:
                new_dict["description"] = full_json["description"]
        except KeyError:
                pass
        try:
                new_dict["publisher"] = full_json["publisher"]["name"]
        except KeyError:
                pass
        try:
                new_dict["datePublished"] = full_json["workExample"]["datePublished"]
        except KeyError:
                pass
        try:
                new_dict["inLanguage"] = full_json["workExample"]["inLanguage"]
        except KeyError:
                pass
        try:
                new_dict["numberOfPages"] = full_json["workExample"]["numberOfPages"]
        except KeyError:
                pass
