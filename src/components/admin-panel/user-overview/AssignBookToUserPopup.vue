...
<template>
    ...
    <div class="flex flex-col w-2/5 h-3/4 bg-white p-8 rounded-3xl fixed top-8">
        ...
        <!-- Close button -->
        <div class="w-full">
            <button v-on:click="this.$emit('closeAssignUserPopup')" type="button" class="float-right">
        ...
        <!-- Title -->
        <div class="p-4 text-center rounded-md underline underline-offset-8 font-extrabold text-xl">Wijs een boek toe aan {{ person }}</div>
        ...
        <div class="flex flex-col h-80 overflow-y-auto border-b-2 divide-y-2 mb-4">
