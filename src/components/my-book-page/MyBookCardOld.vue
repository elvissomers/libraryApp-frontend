...
<div class="max-w-lg p-2">
    ...
    <div class="bg-white shadow-md rounded-lg max-w-xs">
        ...
        <div class="px-5 pb-5">
            ...
            <!-- Title -->
            <router-link :to="{ name: 'book-detail', params: { id: loan.bookId }}" class="hover:text-gray-200">
                <h3 class="text-gray-900 font-semibold text-xl tracking-tight">"{{ loan.bookTitle }}</h3>
            </router-link>
            <!-- Author -->
            <h3 class="text-gray-900 font-normal text-xl tracking-tight">{{ loan.bookAuthor }}</h3>
            <h3 class="text-gray-900 font-normal text-xl tracking-tight">{{ loan.bookIsbn }}</h3>
            <!-- Start date -->
            <h3 class="text-gray-900 font-normal text-xl tracking-tight">Geleend sinds: {{ loan.startDate }}</h3>
            <h3 class="text-gray-900 font-normal text-xl tracking-tight">Exemplaar: {{ loan.copyNumber }}</h3>
            <!-- End date? -->
        </div>
    </div>
</div>
