<template>
    <div class="fixed z-10 inset-0 flex items-center justify-center bg-black bg-opacity-50">
        ...
        <div class="p-4 text-center rounded-md underline underline-offset-8 font-extrabold text-xl">Alle Exemplaren</div>
        <div class="content-center flex flex-row justify-between">
        </div>


        <div class="flex flex-row py-4 border-b-2">
            <button @click="sortReservations('number', sortAscending)" class="w-36 font-extrabold text-left ml-8 ">Exemplaar
                nummer</button>
        </div>
